function [u, v] = testUSSequenceWithTemplateCorrection()
    ...
    for i = 2 : n
        ...
        [u_star, v_star] = LucasKanadeInverseCompositional(firstFrame, current, rect0, (rect_compare(1 : 2) - rect0(1 : 2))' );
        ...
        rectangle('Position', [rect_without(1), rect_without(2), rect_without(3) - rect_without(1), ...
            rect_without(4) - rect_without(2)], 'EdgeColor', 'g');

        rectangle('Position', [rect_lkwtc(1), rect_lkwtc(2), rect_lkwtc(3) - rect_lkwtc(1), ...
            rect_lkwtc(4) - rect_lkwtc(2)], 'EdgeColor', 'y');
        hold off
